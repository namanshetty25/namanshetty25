...
# 👋 Hi there, I'm Naman Shetty!
> **“I build what I wish existed.”**

🚀 **About Me**  
I’m a curious learner driven by innovation and real-world impact. I enjoy building AI-based tools, exploring quantum computing, and creating interactive tech projects. I focus on turning ideas into practical solutions rather than just writing code.

I’m currently a Sophomore pursuing Electrical Engineering at **IIT Indore**, with a strong interest in AI/ML, actively learning, experimenting, and building projects to apply what I learn.

---
🧠 **Featured Projects**
- 🎬 **PIXIO GEN-AI Video Editor** – Next-gen video editing powered by generative AI
- 💰 **Spendie** – Personal finance tracker for smart expense management
- 📺 **Anime Recommender App** – Personalized anime recommendations using machine learning
- ⚖️ **Agents of Justice** – An AI-powered Court Case Simulator using various LLMs through agentic system. 

---
🔍 **What I'm Exploring**
- 🧠 Advanced ML/DL workflows & Vision-Language Models (VLMs)
- 📚 Data Structures & Algorithms (DSA)
- 🤖 Agentic RAG Systems & AI Agents
- 🛰️ Quantum Communication & Hybrid Quantum-ML models
...
![Model Context Protocol](https://img.shields.io/badge/Model_Context_Protocol-4B9CFF?style=for-the-badge)
...
### Deployment & UI
![Vercel](https://img.shields.io/badge/Modal-F7931E?style=for-the-badge&logo=modal&logoColor=white)
...
---
💡 **Passion Areas**  
`AI/ML` • `Quantum Computing` • `Electronics` • `Automation` • `FinTech` • `Cybersecurity`
...
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=namanshetty25&layout=compact&theme=radical)
